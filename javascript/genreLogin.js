                ...
                fetch(`https://api.jikan.moe/v4/anime?q=${query}&limit=10`)
                    ...
                    .then(data => {
                        ...
                        data.data.forEach(anime => {
                            ...
                            resultItem.href = `/html/detailAnime.html?id=${anime.mal_id}&email=${localStorage.getItem('email')}`;
                ...
                data.data.forEach(anime => {
                    ...
                    animeItem.innerHTML = `
                        ...
                        <div class="p-4">
                            ...
                            <button class="mt-2 bg-purple-600 text-white px-4 py-2 rounded hover:bg-purple-700" onclick="window.location.href='/html/detailAnime.html?id=${anime.mal_id}&email=${localStorage.getItem('email')}'">Learn More</button>
                        </div>
                    `;
