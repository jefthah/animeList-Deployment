        ...
        top8Anime.forEach(anime => {
            ...
            card.innerHTML = `
                ...
                <div class="p-4">
                    ...
                    <a href="/html/detailAnime.html?id=${anime.mal_id}&username=${localStorage.getItem('username')}" class="mt-2 inline-block bg-purple-600 text-white px-4 py-2 rounded hover:bg-purple-700">Learn More</a>
                </div>
            `;
