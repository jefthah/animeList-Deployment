    ...
    try {
      ...
      document.getElementById("review-form").addEventListener("submit", async function (event) {
        ...
        try {
          ...
          console.log("Sending review data:", reviewData); // Logging data yang dikirim
          const reviewResponse = await fetch(
            "https://mylistanime-api-anime.vercel.app/animes",
            {
              method: "POST",
              headers: {
          ...
          console.log("Response status:", reviewResponse.status); // Logging status respons
          const responseBody = await reviewResponse.json();
          console.log("Response body:", responseBody); // Logging body respons
          ...
          console.error("Error submitting review:", error); // Logging kesalahan
          Swal.fire({
            icon: "error",
            title: "Kesalahan",
